                              ...
                              child: Column(
                                children: [
                                  Align(
                                    ...
                                    child: Text('Complaint No #${complaintData[index].complain_id}',style: TextStyle(fontSize: 20,color: Colors.black,fontWeight: FontWeight.bold),),
                                  ),
                                  SizedBox(height: 15,),
                                  Row(
                                    children: [
                                      Expanded(
                                        flex: 1,
                                        child: Center(
                                          child: Text('${complaintData[index].date}\t',style: TextStyle(fontSize: 15.0),),
                                        ),
                                      ),
                                      Expanded(
                                        flex: 1,
                                        child: Container(
                                          ...
                                          child: Center(
                                            child: Text('${complaintData[index].status}',style: TextStyle(color: complaintData[index].status == ["Closed"] ? Colors.green
                                                :
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        ...
                                        child: Container(
                                          ...
                                          child: Center(
                                            child: Text('Ward No ${complaintData[index].ward}',style: TextStyle(fontSize:16,color: complaintData[index].status == ["Closed"] ? Colors.green
                                                :
                                            complaintData[index].status == ["New"] ? Colors.red : Colors.blue
                                            ),),
                                          ),
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              children: [
                                Row(
                                  children: [
                                    Text('Issue : ',style: TextStyle(fontSize: 20.0,color: Colors.black),),
                                    Spacer(),
                                    Text('${complaintData[index].complaint_type}',style: TextStyle(fontSize: 20.0,color: Colors.black),),
                                  ],
                                ),
                                SizedBox(height: 05,),
                                Row(
                                  children: [
                                    Text('Solver : ',style: TextStyle(fontSize: 20.0,color: Colors.black),),
                                    Spacer(),
                                    Text('${complaintData[index].fixBy}',style: TextStyle(fontSize: 20.0,color: Colors.black),),
                                  ],
                                ),
                                SizedBox(height: 05,),
                                Row(
                                  children: [
                                    Text('Mobile : ',style: TextStyle(fontSize: 20.0,color: Colors.black),),
                                    Spacer(),
                                    Text(' ${complaintData[index].mobile}',style: TextStyle(fontSize: 20.0,color: Colors.black),),
                                  ],
                                ),
                              ],
                            )
